...
function showProduct(product) {
  ...
  document.querySelector(".productColor p:nth-child(2)").textContent =
    product.basecolour;
  ...
  document.querySelector(".breadcrumbs li:nth-child(3)").textContent =
    product.brandname;
  ...
  if (product.discount) {
    ...
    document.querySelector(".newPrice2").textContent = `${(
      product.price -
